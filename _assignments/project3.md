...
- They may use any modeling approach, algorithm, or architecture (as long asn they do not simply retrain an existing model architecture with the training data).
- They may use any external data resources, such as prononcing dictionaries.
